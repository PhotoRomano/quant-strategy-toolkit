---
name: quality-gate
description: Design and implement a multi-layer fundamental quality screen ("Forensic Gauntlet") that filters a broad stock universe down to structurally sound candidates before any technical scoring or position sizing begins. Use this when someone says "add a quality filter", "screen for fundamentals first", "how do I use Piotroski", "build a fraud detector", "filter out junk before backtesting", "my strategy trades weak companies", "too many fails in my universe", "layer quality over momentum", "DuPont analysis on my candidates", or "prevent bad fundamental bets". Also use when a strategy's live drawdowns trace back to holding companies with poor balance sheets, negative FCF, or signs of earnings manipulation.
---
