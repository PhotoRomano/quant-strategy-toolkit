---
name: metrics-report
description: Compute, interpret, and report backtest performance metrics (CAGR, Sharpe ratio, max drawdown, win rate, profit factor, alpha vs benchmark) with honest caveats and correct formulas. Use this whenever someone asks "what do my backtest numbers mean?", "generate a performance report", "how do I calculate Sharpe?", "is my win rate good?", "what should a backtest report include?", "explain my drawdown", or shares backtest results that need interpreting, sanity-checking, or presenting. Also use before publishing, sharing, or acting on any performance summary — especially when the numbers look suspiciously good.
---
