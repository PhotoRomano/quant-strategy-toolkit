---
name: anti-overfit
description: Detect and disclose overfitting, curve-fitting, and strategy-design bias in quantitative backtests — the silent inflation that makes a strategy look great historically but fail forward. Use this whenever someone asks "is my backtest overfitted?", "am I curve-fitting?", "why does my strategy stop working out-of-sample?", "I ran 30 parameter experiments — how do I know I haven't just data-mined?", "should I trust this backtest?", or whenever you see a strategy with many tuned thresholds, hand-picked dates, a curated universe, or suspiciously smooth equity curves. Pair with the lookahead-audit skill — lookahead-audit catches code that reads future data; this skill catches the human choices made *with knowledge of how history turned out*.
---
