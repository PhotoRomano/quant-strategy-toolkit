---
name: strategy-brief
description: Produce a professional executive brief for a quantitative trading strategy — methodology overview, layered architecture, data-stack table, benchmark comparison chart, and live-trading principles — with honest limitations and no inflated performance claims. Use this when someone asks "write me a strategy brief", "generate an executive summary for my quant system", "create a PDF overview of my strategy", "document my trading architecture for investors or partners", "summarize how my system works", or whenever a strategy needs a structured, readable document that explains the what and why without overstating the edge.
---
